...
public class Activitydemo03 extends AppCompatActivity {
    //页面编号
    ...
    public void SZchongce(int num, AddCZ cz00)
    {
        ...
        AddCZ.Add03(num, cz00, added, Activitydemo03.this);
        //num =1;
        flag = 1;
    }
    ...
    public void SZchongce_zd(int num_zd, AddCZ cz00)
    {
        //转点重测
        TableLayout added = findViewById(R.id.table);
        AddCZ.Add03_zd(num_zd, cz00, added, Activitydemo03.this);
    }
    ...
    public void duquJT(SZcezhan SZcz00,SZceduan SZcd00,int zhuandian)
    {
                ...
                || str_BBzhong.length() < 1 || str_BHzhong.length() < 1 || str_FBzhong.length() < 1 || str_FHzhong.length() < 1)
        {
            ...
            Log.i("Activitydemo03--addcz", back_name);
        }
        else {
            ...
            if (xianchapanduan(SZcz00,Activitydemo03.this) == 0){
                Toast.makeText(Activitydemo03.this, "数据合格，可进行下一站测量", Toast.LENGTH_LONG).show();
                ...
                if (zhuandian == 1)
                {
                    ...
                    TableLayout added = findViewById(R.id.table);
                    AddCZ.Add03(num + 1 - num_zd, cz00, added, Activitydemo03.this);
                }
                SZcz.add(SZcz00);
                SZcd.add(SZcd00);
                Log.i("demo03 String add()", 1 + " " + cz00.sr[1]);
                cz[num - 1] = cz00;

                num += 1;
                Log.i("demo03", "测站：" + Integer.toString(num - 1) + "高差中数：" + Double.toString(SZcz.get(0).gaochazhongshu) + "距离：" + Double.toString(SZcz.get(0).houshiju + SZcz.get(0).qianshiju));
                ...
                Toast.makeText(Activitydemo03.this, SZjisuan.str, Toast.LENGTH_LONG).show();
    ...
    public void  duquDT(AddCZ cz00,SZceduan SZcd00, SZcezhan SZcz00,int zhuandian)
    {
        ...
        Log.i("demo03 String add()", 1 + " " + cz[num - 1].sr[1 + i]);
        Log.i("demo03 String add()", 1 + " " + back_name);
        ...
        Log.i("demo03 String add()", 4 + " " + cz00.sr[4 + i]);
        ...
        Log.i("demo03 String add()", 5 + " " + cz00.sr[5 + i]);

        //读取前黑上丝
        String str_FBshang = new String();
        str_FBshang = cz00.sr[6 + i];

        SZcz00.FB_shang = str_FBshang;
        //assert  str_FBshang != null;
        Log.i("demo03 String add()", 6 + " " + cz00.sr[6 + i]);

        //读取前黑下丝
        String str_FBxia = new String();
        str_FBxia = cz00.sr[7 + i];

        SZcz00.FB_xia  =str_FBxia;
        //assert  str_FBxia != null;
        Log.i("demo03 String add()", 7 + " " + cz00.sr[7 + i]);

        //读取前黑中丝
        String str_FBzhong = new String();
        str_FBzhong = cz00.sr[8 + i];

        SZcz00.FB_zhong = str_FBzhong;
        //assert  str_FBzhong != null;
        Log.i("demo03 String add()", 8 + " " + cz00.sr[8 + i]);

        //读取前红中丝
        String str_FHzhong = new String();
        str_FHzhong = cz00.sr[9 + i];

        SZcz00.FH_zhong = str_FHzhong;
        //assert  str_FHzhong != null;
        Log.i("demo03 String add()", 9 + " " + cz00.sr[9 + i]);

        //读取后红中丝
        String str_BHzhong = new String();
        str_BHzhong = cz00.sr[10 + i];

        SZcz00.BH_zhong = str_BHzhong;
        //assert  str_BHzhong != null;
        Log.i("demo03 String add()", 10 + " " + cz00.sr[10 + i]);
        ...
        if (n > 0)
            ...
            if (xianchapanduan(SZcz00, Activitydemo03.this) == 0)
            {
                ...
                Log.i("demo03", "测站：" + Integer.toString(num - 1) + "高差中数：" + Double.toString(SZcz.get(SZcz.size() - 1).gaochazhongshu) + "距离：" + Double.toString(SZcz.get(SZcz.size() - 1).houshiju + SZcz.get(SZcz.size() - 1).qianshiju));
                ...
                Log.i("demo03 duquDT",Integer.toString(num));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activitydemo03);
        ...
        button_zd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.i("Activity03 addzd called", "The num_zd is:" + num_zd);
                //Toast.makeText(Activitydemo03.this, "技术君努力开发中", Toast.LENGTH_LONG).show();

                Log.i("Activitydemo03", "添加转点   The num is:" + num);
                ...
                {
                    //int i=0;
                    Log.i("demo03--addcz", "The num is:" + num);
        ...
        button_addcz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i("Activitydemo03", "继续测量   The num is:" + num);
                Log.i("Activitydemo03", "继续测量   The flag is:" + flag);
        ...
        button_chongce.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (AddCZ.chongce == 1)
                {
                    ...
                    num = 1;
                    num_zd = 0;
                    Log.i("demo03 重测", Integer.toString(num));

                    //重测
                    SZchongce(num,cz00);

                    //TableLayout added = findViewById(R.id.table);
                    //AddCZ.Add(num, cz00, added, Activitydemo03.this);
                    Log.i("demo03 重测",Integer.toString(num));
                    //num = num_tmp;
                    i += 10;
                }
                else
                    Toast.makeText(Activitydemo03.this,"不可用！",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        button_end.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (num > 1) {
                    ...
                    assert str_BBshang != null;
                    Log.i("demo03 String add()", 3 + " " + cz[num - 1].sr[3 + i]);
                    Log.i("demo03 String add()", 3 + " " + str_BBshang);

                    //读取后黑下丝
                    String str_BBxia = cz[num - 1].sr[4 + i];
                    assert str_BBxia != null;
                    Log.i("demo03 String add()", 4 + " " + cz[num - 1].sr[4 + i]);

                    //读取后黑中丝
                    String str_BBzhong = cz[num - 1].sr[5 + i];
                    assert str_BBzhong != null;
                    Log.i("demo03 String add()", 5 + " " + cz[num - 1].sr[5 + i]);

                    //读取前黑上丝
                    String str_FBshang = cz[num - 1].sr[6 + i];
                    assert str_FBshang != null;
                    Log.i("demo03 String add()", 6 + " " + cz[num - 1].sr[6 + i]);

                    //读取前黑下丝
                    String str_FBxia = cz[num - 1].sr[7 + i];
                    assert str_FBxia != null;
                    Log.i("demo03 String add()", 7 + " " + cz[num - 1].sr[7 + i]);

                    //前黑中丝
                    String str_FBzhong = cz[num - 1].sr[8 + i];
                    assert str_FBzhong != null;
                    Log.i("demo03 String add()", 8 + " " + cz[num - 1].sr[8 + i]);
                    ...
                    assert str_BHzhong != null;
                    Log.i("demo03 String add()", 10 + " " + cz[num - 1].sr[10 + i]);
                    ...
                    if (back_name.length() < 1 || front_name.length() < 1 || str_BBshang.length() < 1 || str_BBxia.length() < 1 || str_FBshang.length() < 1 || str_FBxia.length() < 1
                        ...
                        //判断是否满足各项限差要求
                        if (xianchapanduan(SZcz00[num - 1], Activitydemo03.this) == 0) {
                            Toast.makeText(Activitydemo03.this, "数据合格，可结束测量", Toast.LENGTH_LONG).show();
                            ...
                            Log.i("demo03 结束测量—重测后NUM:",Integer.toString(num));
                            Log.i("demo03 结束测量—重测后 flag:",Integer.toString(flag));
                            ...
                            Log.i("demo03", "测站：" + Integer.toString(num) + "高差中数：" + Double.toString(SZcz00[num - 1].gaochazhongshu) + "距离：" + Double.toString(SZcz00[num - 1].houshiju + SZcz00[num - 1].qianshiju));
                            ...
                            //TableLayout added = findViewById(R.id.table);
                            //AddCZ.Add(num, cz00, added, Activitydemo03.this);
                            Log.i("demo03 结束测量—重测",Integer.toString(num));
                            //num = num_tmp;
                            i += 10;
                            //num =1;
                            //flag = 1;
                    ...
                    Toast.makeText(Activitydemo03.this, "请完成测量", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.i("demo03 back() called", Integer.toString(num));
                SZcz.clear();
                SZcd.clear();
                num = 1;
                num_zd = 0;
